$('#submit').click(function (e) {
    ...
    const soapMessage =
    `<?xml version='1.0' encoding='UTF-8' ?><!-- Generated by Software AG, EntireX XML Mapping Editor (9.10.0.0.380) on 2016-10-12 at 16:13:26 --><SOAP-ENV:Envelope xmlns:SOAP-ENC='http://schemas.xmlsoap.org/soap/encoding/' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:xmm='http://namespace.softwareag.com/entirex/xml/mapping' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:SOAP-ENV='http://schemas.xmlsoap.org/soap/envelope/'>\
    ...
    $.ajax({
        ...
        complete: function (response) {
            ...
            console.dir($(xmlDoc).find('Returns').find('СПЕЦИАЛЬНОСТЬ'));
            $('.target').text(decoded);
        },
        error: function () {
            console.dir('error');
